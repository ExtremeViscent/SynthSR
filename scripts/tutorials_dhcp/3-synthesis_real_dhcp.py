...
result_dir = data_dir+'/3-synthesis_real'
...
output_shape = 100 #128  # in this example we randomly crop the generated pairs to a shape of 128^3
...
prior_means = data_dir+'/labels_classes_priors/prior_means_t2.npy'
prior_stds = data_dir+'/labels_classes_priors/prior_stds_t2.npy'
