...
result_dir = data_dir+'/5-SR-synthesis_real'
...
prior_means_t1 = np.load(data_dir+'/labels_classes_priors/prior_means_t1.npy')
prior_means_t2 = np.load(data_dir+'/labels_classes_priors/prior_means_t2.npy')
prior_means = np.concatenate([prior_means_t1, prior_means_t2], axis=0)
prior_stds_t1 = np.load(data_dir+'/labels_classes_priors/prior_stds_t1.npy')
prior_stds_t2 = np.load(data_dir+'/labels_classes_priors/prior_stds_t2.npy')
prior_stds = np.concatenate([prior_stds_t1, prior_stds_t2], axis=0)
